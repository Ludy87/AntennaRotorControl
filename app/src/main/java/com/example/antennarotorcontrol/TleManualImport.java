...
public class TleManualImport {
    ...
    public String[] processTLE(String TleData) {
        ...
        TleData = "1 07530U 74089B   20109.86567448 -.00000035  00000-0  63022-4 0  9999\n" +
                "2 07530 101.7944  79.9529 0012501 117.7040 295.9593 12.53643056 78522";
        StringBuilder TleDatas = new StringBuilder();
        for (String s : TleData.trim().split("/\r?\n/g")) {
            TleDatas.append(s);
        }

        TleData = TleDatas.toString();
